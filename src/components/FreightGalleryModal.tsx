  ...
  return (
    <AnimatePresence>
      {isOpen && (
        ...
        >
          {/* Backdrop */}
          <div className="absolute inset-0 bg-navy-950/95 backdrop-blur-md" onClick={onClose} />
          ...
          <motion.div
            ...
            className="relative w-full max-w-[1200px] max-h-[90vh] bg-navy-900 border border-white/10 rounded-3xl overflow-hidden shadow-2xl flex flex-col"
          >
            {/* Header */}
            <div className="flex items-center justify-between p-6 border-b border-white/5 bg-navy-800/50">
              <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                {images.map((img, idx) => (
                  <motion.div
                    ...
                    className="group relative aspect-[4/3] rounded-2xl overflow-hidden bg-navy-800 border border-white/5"
                  >
                    <img 
                      src={img.url} 
                      alt={img.caption}
            ...
            {/* Footer / CTA */}
            <div className="p-6 border-t border-white/5 bg-navy-800/50 flex flex-col sm:flex-row items-center justify-between gap-4">

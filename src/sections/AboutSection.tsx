...
const stats = [
  { value: '2012', label: 'Founded', icon: Calendar },
  { value: '40+', label: 'Team members', icon: Users },
  { value: '12', label: 'Regional hubs', icon: MapPin },
];
    ...
    >
      ...
      <div className="relative z-[3] w-full h-full flex items-center">
        ...
        <div className="absolute left-[6vw] top-[28vh] w-[34vw] max-w-lg">
          ...
          >
            DELO TRANS INC started with one route and a simple rule: deliver what you promise. Today, we run a coordinated network built for speed, compliance, and long-term partnerships.
          </p>
        </div>
        ...
        <div
          ref={statsRef}
          className="absolute left-[6vw] top-[48vh] flex flex-wrap gap-4 lg:gap-6"
        >
          {stats.map((stat, index) => (
            ...
            >
              ...
              <p className="font-heading text-2xl lg:text-3xl font-bold text-white mb-1">
                {stat.value}
              </p>

    ...
    >
      ...
      <div className="relative z-[10] w-full max-w-7xl mx-auto px-5 sm:px-8 lg:px-12 flex flex-col xl:flex-row items-center gap-12 lg:gap-20">
        ...
        <div className="w-full xl:w-5/12 flex flex-col items-center xl:items-start text-center xl:text-left pt-10 xl:pt-0">
          ...
          <h1
            ref={headlineRef}
            className="font-heading text-5xl sm:text-6xl lg:text-7xl font-bold text-white leading-[1.1] tracking-tight mb-6 drop-shadow-xl"
          >
          ...
          <p
            ref={bodyRef}
            className="text-base sm:text-lg text-gray-300 leading-relaxed max-w-2xl xl:max-w-none drop-shadow-md mb-6"
          >
          ...
          {stats.map((stat, index) => (
            ...
            >
              ...
              <div className="relative z-10 flex flex-col md:flex-row xl:flex-col items-start gap-5">
                ...
                <div>
                  <h3 className="font-heading text-4xl sm:text-5xl font-bold text-white mb-2 tracking-tight group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-gradient-to-r group-hover:from-white group-hover:to-gray-400 transition-all">
                    {stat.value}
                  </h3>

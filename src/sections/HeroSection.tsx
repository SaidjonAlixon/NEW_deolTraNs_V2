  ...
  return (
    ...
    >
      ...
      <div ref={bgRef} className="absolute inset-0 z-[1]">
        ...
        />
        <div className="absolute inset-0 bg-slate-100/40 dark-theme:bg-app/40 backdrop-blur-md transition-colors duration-500"></div>
        <div className="absolute inset-0 bg-gradient-to-r from-white/98 via-white/80 to-transparent dark-theme:from-app-deep/90 dark-theme:via-app-deep/60 w-[70%]"></div>
      </div>
      ...
      <div className="lg:hidden relative z-[3] flex flex-col justify-between h-full px-5 pt-24 pb-6">
        ...
        <div className="grid grid-cols-2 gap-3 mb-7">
          {[
            ...
            <div key={s.label} className="bg-card/40 backdrop-blur-sm border border-border/20 rounded-xl px-4 py-3 text-center">
      ...
      <div className="hidden lg:block relative z-[3] w-full h-full">
        ...
        >
          ...
          <h1 className="font-heading text-5xl sm:text-6xl lg:text-7xl font-bold text-foreground leading-[1.05] tracking-tight mb-8 drop-shadow-2xl uppercase">
            POWER-ONLY CARRIER<br />BUILT FOR{' '}
          ...
          <div className="mt-4 border-l-2 border-orange/50 pl-6 py-4 bg-gradient-to-r from-card/60 to-transparent backdrop-blur-md rounded-r-xl w-full max-w-[600px] min-h-[100px] flex items-center shadow-lg lg:shadow-none">
            <p key={`desc-${currentDescIndex}`} className="text-base lg:text-lg text-foreground leading-relaxed drop-shadow-lg font-light animate-fade-in w-full">
              {descriptions[currentDescIndex]}
            </p>
          </div>
        </div>
        ...
        >
          <div className={`w-full h-full bg-slate-900/40 day-theme:bg-white day-theme:lg:bg-white/90 backdrop-blur-2xl rounded-tr-3xl rounded-bl-3xl p-8 border-t-[3px] border-r-2 shadow-2xl hover:border-orange/50 hover:shadow-orange/20 transition-all duration-700 card-lift group overflow-hidden ${activeCard === 0 ? 'scale-105 opacity-100 border-orange/80' : 'scale-95 opacity-50 border-gray-200 dark-theme:border-white/20'}`}>
            <div className="absolute top-0 right-0 w-24 h-24 bg-gradient-to-bl from-orange/10 to-transparent pointer-events-none rounded-tr-3xl"></div>
            ...
            <div className="relative z-10">
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-4">
                  <div className="w-14 h-14 rounded-full bg-orange/10 dark-theme:bg-app-deep/80 flex items-center justify-center border border-orange/40 shadow-sm group-hover:scale-110 transition-transform">
                    <MapPin className="w-7 h-7 text-orange" />
                  </div>
                  <div>
                    <p className="font-mono text-[11px] text-red-600 day-theme:font-black dark-theme:text-orange tracking-[0.2em] mb-1 font-bold">NOW HIRING</p>
                    <h3 className="font-heading font-bold text-2xl text-foreground dark-theme:text-white tracking-wide">Owner Operators</h3>
                  </div>
                </div>
              </div>
              <p className="text-sm lg:text-base text-foreground/90 day-theme:text-slate-900 day-theme:font-bold dark-theme:text-gray-300 leading-relaxed font-medium mb-6">
              ...
              <div className="flex items-center justify-between w-full border-t border-gray-100 dark:border-border/10 pt-4">
                <div className="flex items-center gap-2 cursor-pointer text-orange text-sm font-bold tracking-[0.15em] uppercase hover:text-red-600 transition-colors">
        ...
        <div
          ...
          style={{ opacity: 0, transform: 'translateX(40vw)' }}
        >
          <div className={`w-full h-full bg-slate-900/40 day-theme:bg-white day-theme:lg:bg-white/90 backdrop-blur-3xl rounded-tl-3xl rounded-br-3xl p-8 border-b-[3px] border-l-2 shadow-2xl hover:border-blue-400/60 transition-all duration-700 card-lift group overflow-hidden ${activeCard === 1 ? 'scale-105 opacity-100 border-blue-500/80 shadow-[0_0_60px_rgba(59,130,246,0.2)]' : 'scale-95 opacity-50 border-gray-200 dark-theme:border-blue-500/30'}`}>
            ...
            <div className="relative z-10">
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 rounded-xl bg-blue-50 dark-theme:bg-app/50 flex items-center justify-center border border-blue-500/50 shadow-sm group-hover:rotate-12 transition-transform">
                    <Globe className="w-6 h-6 text-blue-500 dark-theme:text-blue-400" />
                  </div>
                  <div>
                    <p className="font-mono text-[10px] text-blue-700 day-theme:font-black dark-theme:text-blue-400 tracking-[0.2em] mb-1 font-bold">COMPANY DRIVERS</p>
                    <h3 className="font-heading font-bold text-xl text-foreground dark-theme:text-white tracking-wide">Drive Less. Earn More.</h3>
                  </div>
                </div>
              </div>
              <p className="text-sm text-foreground/90 day-theme:text-slate-900 day-theme:font-bold dark-theme:text-gray-300 leading-relaxed font-medium mb-6">
              ...
              <div className="flex items-center justify-between w-full border-t border-gray-100 dark:border-border/10 pt-4">
                <div className="flex items-center gap-2 cursor-pointer text-blue-600 dark:text-blue-400 text-sm font-bold tracking-[0.15em] uppercase hover:text-blue-800 transition-colors">
                  <span className="group-hover:translate-x-2 transition-transform">Initialize Route</span>
                  <ArrowRight className="w-4 h-4 ml-1" />
                </div>
                <div className="border border-blue-500/30 rounded px-2 py-1 text-[10px] text-blue-600 dark:text-blue-400 tracking-wider font-bold">SYS.ONLINE</div>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="px-6 lg:px-12 py-4 lg:py-6">
            <div ref={statsRef} className="grid grid-cols-4 gap-8">
              <div className="text-left" style={{ opacity: 0 }}>
                <p className="font-heading text-3xl font-bold text-foreground drop-shadow-md">{stats.vehicles}+</p>
                <p className="text-xs text-muted-foreground mt-1">Units Nationwide</p>
              </div>
              <div className="text-left" style={{ opacity: 0 }}>
                <p className="font-heading text-3xl font-bold text-foreground drop-shadow-md">$1,000</p>
                <p className="text-xs text-muted-foreground mt-1">Sign-On Bonus</p>
              </div>
              <div className="text-left" style={{ opacity: 0 }}>
                <p className="font-heading text-3xl font-bold text-foreground drop-shadow-md">{stats.countries}+</p>
                <p className="text-xs text-muted-foreground mt-1">States Covered</p>
              </div>
              <div className="text-left" style={{ opacity: 0 }}>
                <p className="font-heading text-3xl font-bold text-foreground drop-shadow-md">{stats.experience}+ yrs</p>
                <p className="text-xs text-muted-foreground mt-1">In Business</p>
              </div>
            </div>
          </div>
        </div>
